...
from sklearn.model_selection import train_test_split
X_train, X_test, y_train, y_test = train_test_split(X_train, y_train, test_size=0.4, train_size=0.6) 
...
map_characters = {0: 'A', 2: 'C', 8: 'I', 9: 'J', 10: 'K', 11: 'L', 14: 'O', 15: 'P', 26: 'del', 27: 'nothing', 28: 'space', 29: 'other'}
...
def pretrainedNetwork(xtrain,ytrain,xtest,ytest,pretrainedmodel,pretrainedweights,classweight,numclasses,numepochs,optimizer,labels):
    ...
    return model
pretrainedNetwork(X_train, y_trainHot, X_test, y_testHot,pretrained_model_1,weight_path1,class_weight1,30,5,optimizer1,map_characters1)
